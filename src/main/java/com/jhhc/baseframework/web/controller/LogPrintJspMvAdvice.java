 ...
 * @author yecq
 */
@Component("log_print_jsp_mv_advice")
public class LogPrintJspMvAdvice {

    private static Logger log = Logger.getLogger(LogPrintJspMvAdvice.class);

    public ModelAndView print(ProceedingJoinPoint p) {
        String mapping = "";    // @RequestMapping的值
        String param = "";          // 路径中的含有RequestParam的参数
        ModelAndView jsp = null;
        String msg = "";
        ...
        // 打印日志信息
        log.debug(msg + ", 请求" + jsp.getViewName() + ".jsp,  ==> ok");
